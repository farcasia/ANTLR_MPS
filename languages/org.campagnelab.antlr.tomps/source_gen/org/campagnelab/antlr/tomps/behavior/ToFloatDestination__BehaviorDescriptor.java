...
public final class ToFloatDestination__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x443e8c43ffcf6763L, "org.campagnelab.antlr.tomps.structure.ToFloatDestination");
  ...
  /*package*/ static String name_id2uLbzznpwAh(@NotNull SNode __thisNode__) {
    return (String) Destination__BehaviorDescriptor.name_id2uLbzznpwAh.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x443e8c43ffcf6763L, 0x443e8c43ffcf6764L, "toConvert")));
  }
  /*package*/ static SNode to_idWSCumwYo$I(@NotNull SNode __thisNode__) {
    return (SNode) Destination__BehaviorDescriptor.to_idWSCumwYo$I.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x443e8c43ffcf6763L, 0x443e8c43ffcf6764L, "toConvert")));
  }
  /*package*/ static SNode type_id5qM9mr9Mqo7(@NotNull SNode __thisNode__) {
    return _quotation_createNode_al22mq_a0a2();
  }
  /*package*/ static SNode cellModel_id1AEWcuffMHI(@NotNull SNode __thisNode__, String cardinality) {
    return Destination__BehaviorDescriptor.cellModel_id1AEWcuffMHI.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x443e8c43ffcf6763L, 0x443e8c43ffcf6764L, "toConvert")), cardinality);
  }
  /*package*/ static SNode textGenAppendPart_id3V2IUSqzmkO(@NotNull SNode __thisNode__, String cardinality) {
    return Destination__BehaviorDescriptor.textGenAppendPart_id3V2IUSqzmkO.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x443e8c43ffcf6763L, 0x443e8c43ffcf6764L, "toConvert")), cardinality);
  }

  /*package*/ ToFloatDestination__BehaviorDescriptor() {
    super(REGISTRY);
  }
