...
public final class ConvertToMPS__BehaviorDescriptor extends BaseBHDescriptor {
  private static final Logger LOG = LogManager.getLogger(ConvertToMPS__BehaviorDescriptor.class);
  ...
  /*package*/ static Language getLanguage_id1p7oQN$sEF_(@NotNull SNode __thisNode__, String moduleId, String languageName) {
    ...
    try {
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LoggingRuntime.legacyLog(Level.ERROR, "Unable to retrieve module reference for language: " + SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x6a1bb02ea6061b82L, 0x69d936b00a14fa05L, "destinationLanguageName")), ConvertToMPS__BehaviorDescriptor.class, e);
      }
      return null;
    }
  }
  ...
  /*package*/ static Scope getScope_id3fifI_xCJOQ(@NotNull SNode __thisNode__, SNode kind, SNode child) {
    ...
    return ((Scope) ScopeProvider__BehaviorDescriptor.getScope_id3fifI_xCJOQ.invoke0(__thisNode__, MetaAdapterFactory.getInterfaceConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x33d23ee961a0cbf3L, "jetbrains.mps.lang.core.structure.ScopeProvider"), kind, child));
  }
