...
public final class PropertyDestination__BehaviorDescriptor extends BaseBHDescriptor {
  private static final Logger LOG = LogManager.getLogger(PropertyDestination__BehaviorDescriptor.class);
  ...
  /*package*/ static SNode cellModel_id1AEWcuffMHI(@NotNull SNode __thisNode__, String cardinality) {
    if (LOG.isInfoEnabled()) {
      LoggingRuntime.legacyLog(Level.INFO, "visiting destination (property)", PropertyDestination__BehaviorDescriptor.class, null);
    }
